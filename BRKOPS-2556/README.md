# Get Out of the 90s - Modern Troubleshooting with Cisco APIs and Splunk

This repository includes the supplemental material for the Cisco Live session: BRKOPS-2556. Here you can find the code and SPL queries for the demos that were delivered during the session.
